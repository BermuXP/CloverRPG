...
import tv.bermu.cloverrpg.commands.subcommands.character.SelectSubCommand;
...
public class ClassCommand implements CommandExecutor, TabCompleter {
    ...
    public ClassCommand(JavaPlugin plugin, ConfigurationSection classesSection, MessageFormatter messageFormatter) {
        ...
        subcommands.put("select",
                new SelectSubCommand(messageFormatter, Main.baseCommandPermission + "class.select"));
    }
